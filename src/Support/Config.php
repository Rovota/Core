...
class Config implements ArrayAccess, IteratorAggregate, Countable, Arrayable, JsonSerializable
{
	use TypeAccessors;
	...
	public function set(string|array $key, mixed $value = null): Config
	{
		if (is_array($key)) {
