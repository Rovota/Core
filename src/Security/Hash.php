...
final class Hash
{
	...
	{
		return password_hash($string, PASSWORD_DEFAULT, ['cost' => Registry::int('core_hash_cost', 12)]);
	}
	...
	{
		return password_needs_rehash($hash, PASSWORD_DEFAULT, ['cost' => Registry::int('core_hash_cost', 12)]);
	}
